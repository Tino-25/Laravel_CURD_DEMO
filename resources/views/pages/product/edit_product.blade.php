...
<form role="form" action="{{URL::to('/update-product/'.$pro->product_id)}}" method="post" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" id="exampleFormControlTextarea1" name="product_desc" rows="3">{{$pro->product_desc}}</textarea>

    <label for="exampleFormControlTextarea1">Product Content</label>
    <textarea class="form-control"id="exampleFormControlTextarea2" name="product_content" rows="3">{{$pro->product_content}}</textarea>
    ...
    <div class="input-group mb-3">
      ...
      aria-label="Amount (to the nearest dollar)" value="{{$pro->product_price}}">
    ...
    <!-- Lấy tên ảnh cũ để xóa - rồi mới thêm ảnh mới -->
